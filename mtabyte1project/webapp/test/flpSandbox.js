		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#mtabyte1project-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"mtabyte1project-display": {
								"semanticObject": "mtabyte1project",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=mtabyte1project",
									"url": sap.ui.require.toUrl("mtabyte1project")
								}
							}
						}
					}
